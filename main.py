...
pygame.display.set_caption("A* Pathfinding AI Visualizer")
...
def draw(win, grid, rows, width):
    ...
    pygame.draw.rect(win, (30,30,30), (0, width-60, width, 60))
    inst = font.render("Left Click: Draw | Right Click: Erase | SPACE: Run AI | C: Clear", True, WHITE)
    win.blit(inst, (20, width-45))
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if pygame.mouse.get_pressed()[0]: # LEFT CLICK
                ...
                if pos[1] > width - 60: continue # Prevent clicking on instruction bar
